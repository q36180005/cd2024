...
# 內容管理系統41123137
# 第十三周進度
1.將零件匯入NXopen進行內建record全程錄影零件從無到有的過程(零件為隨機設定),(但後面開啟play時可能會出現錯誤,目前正在修正中)

[零件黨點我]
[零件黨點我]:https://drive.google.com/file/d/1rA23gRUDBuXQxyS6OXK94wcaP9hEiQIG/view?usp=sharing
